...
export function CollegeCategoryDialog({
  open,
  onOpenChange,
  collegeId,
  collection,
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      return create({ data: { collegeId, collection, names } });
    },
    onSuccess: (res) => {
      ...
      qc.invalidateQueries({ queryKey: ["categories", collegeId, collection] });
        ...
        <div className="space-y-4 py-2">
          ...
          {!isEdit && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-black/45">
                Suggestions from every college. Selecting one creates a new category for this college only.
              </p>
            </div>
          )}
